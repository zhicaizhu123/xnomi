...
export class RandomName {
  ...
  private allName = this.femaleNameItems.concat(this.maleNameItems)

  private familyNameItemsAll = this.familyNameItemsSin.concat(this.familyNameItemsSur)
