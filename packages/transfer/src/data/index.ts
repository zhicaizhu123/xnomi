 ...
 */
export function list2Hash<T, U = T>(
  list: T[],
  key = 'id',
  cb?: (item: T) => U
) {
 ...
 * @return {Tree<T>[]} 
 */
export function list2Tree<T extends Record<string, any>>(list: Tree<T>[], config: Partial<TreeConfig> = {}) {
 ...
 */
export function tree2Map<T extends { children?: T[] }>(tree: T[], config: Partial<TreeConfig> = {}, includeChildren = false) {
 ...
 */
export function getChainInfo<T extends { children?: T[] }>(tree: T[], id: string | number, config: Partial<TreeConfig> = {}) {
 ...
 * @return {T | undefined} 
 */
export function findTreeNode<T extends { children?: T[] }>(tree: T[], id: string | number, config: Partial<TreeConfig> = {}) {
